...
const rateQuantity =
    Number(
        document.querySelector("#rateQuantity").value
    );
...
if (
    ...
    showError(
        "Please enter a valid reference quantity."
    );
...
if (quantityKg >= 1) {
    ...
    mainResult =
        formatNumber(quantityKg) +
        " KG";

} else if (quantityG >= 1) {

    mainResult =
        formatNumber(quantityG) +
        " grams";

} else {

    mainResult =
        formatNumber(quantityMg) +
        " mg";
}
